$("#main-navbar").load("public/navbar.html");
$("#mobile-nav").load("public/navbar-mobile.html");
$("#footer").load("public/footer.html");
$("#preloader").load("public/preloader.html");
...
var navbar = {
	...
	init: function() {
		var that = this;
		$('#main-navbar').on('click','.main-reorder',function(e) {
			e.preventDefault();
...
var mobileNav ={
		...
		open:function() {
		$('#mobile-nav').on('click','.reorder a',function(e) {
			e.preventDefault();
		...
		$('#mobile-nav').on('click','.flyout-menu .open-children',function(e) {
			e.preventDefault();
			var that = this;
...
var verticalSlider = (function(){
	let init=function(autoScrolling) {
		if (mobile) {
			return;
		}
